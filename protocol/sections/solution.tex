...
Es wurde ein simples Kommandzeileninterface entwickelt, \"uber das der Buntzer nach der Registrierung des Clients am Server (bzw. nach der Anmeldung im Chatroom), Nachrichten senden kann.
